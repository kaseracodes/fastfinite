export const calculateRent = (pickupDate, dropoffDate, packageRates, type) => {
    ...
    if (type === "premiumBike") {
        ...
        hours %= 24;
        totalRent += months * packageRates.monthly + weeks * packageRates.weekly + days * packageRates.daily + hours * packageRates.hourly;
    } else {
        ...
        days %= 7;
        totalRent += months * packageRates.monthly + weeks * packageRates.weekly + days * packageRates.daily;
    }
